...
export default function ChampionStats() {
  return <div className="mt-10">
    <div className="mb-5 flex items-center gap-3"><p className="font-mono text-[10px] font-bold uppercase tracking-[0.16em] text-[#6c625b]">Le palmarès en chiffres</p></div>
